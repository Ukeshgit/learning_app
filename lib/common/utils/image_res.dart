class ImageRes {
  ImageRes._(); //way to make private constructor
  ...
  static const String play_circle = "$_imageBase/play-circle1.png";
  static const String message_circle = "$_imageBase/message-circle.png";
  static const String person = "$_imageBase/user.png";
  static const String profile = "$_imageBase/person2.png";
  static const String lock = "$_imageBase/lock.png";
  static const String searchFilter = "$_imageBase/options.png";
